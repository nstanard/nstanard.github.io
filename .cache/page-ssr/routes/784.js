...
/* harmony export */ });
/* unused harmony exports MDXContext, withMDXComponents, useMDXComponents */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2942);
/**
...
__webpack_require__.d(__webpack_exports__, {
  ...
  np: () => (/* binding */ themes_exports)
});

// UNUSED EXPORTS: Prism, normalizeTokens, useTokenize
...
var useGetLineProps = (themeDictionary) => (0,external_C_Users_Neal_Documents_Development_nealstanard_com_node_modules_react_index_js_.useCallback)(
  (_a) => {
...
var useGetTokenProps = (themeDictionary) => {
  const styleForToken = (0,external_C_Users_Neal_Documents_Development_nealstanard_com_node_modules_react_index_js_.useCallback)(
    ({ types, empty }) => {
  ...
  return (0,external_C_Users_Neal_Documents_Development_nealstanard_com_node_modules_react_index_js_.useCallback)(
    (_a) => {
...
var useTokenize = ({ prism, code, grammar, language }) => {
  return (0,external_C_Users_Neal_Documents_Development_nealstanard_com_node_modules_react_index_js_.useMemo)(() => {
    if (grammar == null)
...
// src/index.ts
var Highlight2 = (props) => (0,external_C_Users_Neal_Documents_Development_nealstanard_com_node_modules_react_index_js_.createElement)(Highlight, __spreadProps(__spreadValues({}, props), {
