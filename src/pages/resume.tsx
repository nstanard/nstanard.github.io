...
const ResumePage = () => {
  ...
  const skills = {
    ...
    tools: ["NPM", "Firebase", "Git/GitHub", "Docker", "Storybook", "Jira", "Twilio", "Postman", "Ngrok", "Auth0", "CoPilot", "Cursor", "Ollama", "Vim", "VSCode", "Figma", "Adobe Suite", "Jenkins", "CircleCI", "CI/CD"],
